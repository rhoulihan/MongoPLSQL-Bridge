...
public final class StringExpression implements Expression {
     ...
     */
    public static StringExpression indexOfCP(Expression string, Expression substring, Expression start, Expression end) {
     ...
     */
    public static StringExpression regexMatch(Expression input, Expression regex, Expression options) {
     ...
     */
    public static StringExpression replaceOne(Expression input, Expression find, Expression replacement) {
     ...
     * @param replacement the replacement string
     */
    public static StringExpression replaceAll(Expression input, Expression find, Expression replacement) {
