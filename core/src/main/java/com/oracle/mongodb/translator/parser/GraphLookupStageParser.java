...
public final class GraphLookupStageParser {
    ...
    public GraphLookupStage parse(Document doc) {
        ...
        String startWith = parseStartWith(doc.get("startWith"));
        String connectFromField = getRequiredString(doc, "connectFromField");
        String connectToField = getRequiredString(doc, "connectToField");
        ...
        if (maxDepthValue != null) {
            if (maxDepthValue instanceof Number) {
                ...
                throw new IllegalArgumentException(
                    "$graphLookup 'maxDepth' must be a number, got: " + maxDepthValue.getClass().getSimpleName());
            }
        }
        ...
        if (depthFieldValue != null) {
            if (depthFieldValue instanceof String) {
                ...
                throw new IllegalArgumentException(
                    "$graphLookup 'depthField' must be a string, got: " + depthFieldValue.getClass().getSimpleName());
            }
        }
    ...
    private String getRequiredString(Document doc, String fieldName) {
        ...
        if (value == null) {
            throw new IllegalArgumentException(
                "$graphLookup requires '" + fieldName + "' field");
        }
        if (!(value instanceof String)) {
            throw new IllegalArgumentException(
                "$graphLookup '" + fieldName + "' must be a string, got: " + value.getClass().getSimpleName());
        }
        return (String) value;
    }
}
