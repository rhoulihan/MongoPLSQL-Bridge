...
/**
 * Represents a $merge stage that writes the results of the aggregation pipeline
 ...
 * </pre>
 *
 * <p>Note: This is a stub implementation for the AST structure.
 * Full MERGE support requires additional work.
 */
public final class MergeStage implements Stage {
     ...
     */
    public MergeStage(String targetCollection, List<String> onFields,
                      WhenMatched whenMatched, WhenNotMatched whenNotMatched) {
    ...
    public String toString() {
        return "MergeStage(target=" + targetCollection
            + ", on=" + onFields
