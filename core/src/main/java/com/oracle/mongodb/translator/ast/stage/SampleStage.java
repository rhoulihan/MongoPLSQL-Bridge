 ...
 *
 * <p>The $sample stage takes a document with a "size" field specifying the number of random
 * documents to return. In Oracle SQL, this is translated to ORDER BY DBMS_RANDOM.VALUE with FETCH
 * FIRST n ROWS ONLY.
 *
 * <p>Example:
 *
