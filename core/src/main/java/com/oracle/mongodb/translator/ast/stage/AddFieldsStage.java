...
/**
 * Represents an $addFields (or $set) stage that adds new fields to documents.
 * In Oracle, this translates to additional computed columns in the SELECT clause.
 *
 * <p>MongoDB syntax:
 * <pre>
 ...
 * </pre>
 *
 * <p>Note: Unlike $project, $addFields preserves all existing fields and just adds new ones.
 * This distinction is handled at the pipeline rendering level.
 */
