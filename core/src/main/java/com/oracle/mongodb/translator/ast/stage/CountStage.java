 ...
 *
 * <p>The $count stage takes a string specifying the name of the output field that will contain the
 * count. It returns a single document with the count.
 *
 * <p>Example:
 *
 * <pre>
...
public final class CountStage implements Stage {
   ...
   *
   * @param fieldName the name of the field that will contain the count (must not be null, empty, or
   *     start with $)
   */
