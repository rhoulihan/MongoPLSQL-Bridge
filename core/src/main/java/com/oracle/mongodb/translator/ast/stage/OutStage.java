...
/**
 * Represents a $out stage that writes the results of the aggregation pipeline to a specified
 * collection, replacing the collection if it exists.
 *
 * <p>MongoDB syntax:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Note: This is a stub implementation. Full $out support requires CREATE TABLE AS SELECT or
 * DROP/INSERT pattern.
 */
