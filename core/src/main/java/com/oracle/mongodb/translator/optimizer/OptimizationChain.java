 ...
 *
 * <p>The optimization chain applies each optimizer in sequence,
 * passing the output of one optimizer as input to the next.
 *
 * <p>Example usage:
 * <pre>
...
public class OptimizationChain implements PipelineOptimizer {
     ...
     * <ol>
     *   <li>Predicate pushdown - moves $match stages early</li>
     *   <li>Sort-limit combination - optimizes Top-N queries</li>
     * </ol>
     */
    public static OptimizationChain standard() {
        return builder()
            .add(new PredicatePushdownOptimizer())
            .add(new SortLimitOptimizer())
            .build();
    }
