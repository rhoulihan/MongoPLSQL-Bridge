 ...
 *
 * <p>When a $sort is immediately followed by a $limit, this optimizer
 * marks the sort with a "limit hint" that allows the SQL generator
 * to use Oracle's Top-N optimization (FETCH FIRST N ROWS ONLY).
 *
 * <p>This optimization is important because:
 * <ul>
 *   <li>Oracle can stop sorting after finding the top N rows</li>
 *   <li>Memory usage is reduced (only N rows need to be kept)</li>
 *   <li>Indexes can be used more efficiently</li>
 * </ul>
 */
