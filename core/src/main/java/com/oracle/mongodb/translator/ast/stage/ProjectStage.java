...
/**
 * Represents a $project stage that shapes the output documents.
 * Translates to Oracle's SELECT clause with JSON_VALUE/JSON_QUERY for field extraction.
 *
 * <p>Supports:
 * <ul>
 *   <li>Field inclusion: { field: 1 } or { field: true }</li>
 *   <li>Field exclusion: { field: 0 } or { field: false }</li>
 *   <li>Field rename/expression: { newName: "$existingField" }</li>
 *   <li>Computed fields: { newField: { $add: [...] } }</li>
 * </ul>
 */
