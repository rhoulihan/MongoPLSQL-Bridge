...
class StringExpressionTest {
  ...
  void shouldRenderConcat() {
    var expr =
        StringExpression.concat(
            List.of(LiteralExpression.of("Hello "), FieldPathExpression.of("name")));
  ...
  void shouldRenderSubstr() {
    ...
    var expr =
        StringExpression.substr(
            FieldPathExpression.of("text"), LiteralExpression.of(0), LiteralExpression.of(5));
  ...
  void shouldRenderSubstrWithNonZeroStart() {
    ...
    var expr =
        StringExpression.substr(
            FieldPathExpression.of("text"), LiteralExpression.of(3), LiteralExpression.of(10));
  ...
  void shouldRenderSplit() {
    // {$split: ["$text", ","]}
    var expr = StringExpression.split(FieldPathExpression.of("text"), LiteralExpression.of(","));
  ...
  void shouldRenderIndexOfCp() {
    // {$indexOfCp: ["$text", "abc"]}
    var expr =
        StringExpression.indexOfCp(FieldPathExpression.of("text"), LiteralExpression.of("abc"));
  ...
  void shouldRenderRegexMatch() {
    ...
    var expr =
        StringExpression.regexMatch(
            FieldPathExpression.of("description"), LiteralExpression.of("pattern"));
  ...
  void shouldRenderRegexFind() {
    ...
    var expr =
        StringExpression.regexFind(FieldPathExpression.of("text"), LiteralExpression.of("\\d+"));
  ...
  void shouldReturnNewOps() {
    assertThat(
            StringExpression.split(FieldPathExpression.of("x"), LiteralExpression.of(",")).getOp())
        .isEqualTo(StringOp.SPLIT);
    assertThat(
            StringExpression.indexOfCp(FieldPathExpression.of("x"), LiteralExpression.of("a"))
                .getOp())
        .isEqualTo(StringOp.INDEX_OF_CP);
    assertThat(
            StringExpression.regexMatch(FieldPathExpression.of("x"), LiteralExpression.of("a"))
                .getOp())
        .isEqualTo(StringOp.REGEX_MATCH);
    assertThat(
            StringExpression.regexFind(FieldPathExpression.of("x"), LiteralExpression.of("a"))
                .getOp())
        .isEqualTo(StringOp.REGEX_FIND);
    assertThat(
            StringExpression.replaceOne(
                    FieldPathExpression.of("x"),
                    LiteralExpression.of("a"),
                    LiteralExpression.of("b"))
                .getOp())
